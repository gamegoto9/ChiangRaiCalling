...
public class AmpureListItem extends BaseCustomViewGroup {
    ...
    public AmpureListItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        initInstances();
    ...
    public AmpureListItem(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public AmpureListItem(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
